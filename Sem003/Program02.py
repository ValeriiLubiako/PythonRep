...
# выполняется ввод числа Х, затем определяется значение элемента массива наиболее близкого к Х.
# Число Х запрашивается в цикле, предоставляя возможность проверять подряд несколько чисел.
# Выход из цикла по комбинации клавиш Ctrl-Z + Enter
#
#
Flag = True
Flagin = True
...
# Если полученный ввод не число, будет вызвано исключение
        ...
        print("EOF! Выходим из цикла ввода.")
